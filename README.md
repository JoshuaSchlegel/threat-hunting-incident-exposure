# 🔍**Detected Sensitive Asset Exposure (Public Facing IPs)**
...
1. **🔍 Archiving Activity:**  
   - **Observed Behavior:**  Windows-target-1 has been internet-facing for several days, the public IPAddress was in the Logs. Last Internet facing time: `2025-09-20T21:39:40.9329251Z`
...
<img width="1374" height="817" alt="image" src="https://github.com/user-attachments/assets/466202a2-a2fc-46b6-bb9c-2130d66d7360" />
...
<img width="1406" height="851" alt="image" src="https://github.com/user-attachments/assets/fab0748c-5fc0-4738-a132-72249c2c1aaa" />

---

The top 7 most failed login attempt IP addresses have not been able to successfully break into VM.

```kql
let RemoteIPsInQuestion = dynamic(["147.93.150.115","178.22.24.78", "59.3.82.127", "80.94.95.166", "57.129.140.32", "176.46.158.12", "178.22.24.197"]);
DeviceLogonEvents
| where LogonType has_any("Network", "Interactive", "RemoteInteractive", "Unlock")
...
There were zero (0) successful remote/network logins in the last 30 days for 'labuser' account:
...
<img width="1412" height="592" alt="image" src="https://github.com/user-attachments/assets/7c2f8f42-e719-4664-bc07-2733e4b0c2d2" />
...
<img width="1403" height="610" alt="image" src="https://github.com/user-attachments/assets/275d1361-79a6-4664-a90c-cfd432a271d9" />
...
- **Author Contact**: [LinkedIn](https://www.linkedin.com/in/joshuaschlegel/)  
- **Date**: September 2025
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `Sept 2025`    | `Joshua Schlegel`   |
```
